# Release v1.7.1: Bugfix for Workflow Validator

**Release Date:** 2024-12-16

## 🐛 Bug Fixes

### Fixed Missing Import in `workflow_validator.py`
...
- ✅ `validate_workflow` tool can be called without errors
...
- Affects: All users of `validate_workflow` and `validate_workflow_json` tools
